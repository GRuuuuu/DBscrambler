...
(0,'전기','010-1234-1114','kyjeon@ibm.com','서울특별시 도봉구 테헤란로 민지안최동(벽산) 110동 124호','13123','880218-101010'),
(1,'이연','010-3452-2322','sylee@ibm.com','인천광역시 도봉구 언주341로 정웅이최마을 123동 555호','14852','950118-201618'), 
(2,'공진','010-2342-1334','jkkong@ibm.com','경상북도 괴산군 서초대길 66동','69117','811218-175110'), 
(3,'김태','010-2222-2344','htkim@ibm.com','서울특별시 마포구 서초중앙로 예진김면 103호','54904','840928-134530')
...
(NULL,'전기연',NULL,NULL,'서울특별시, 도봉구 테헤란로 민지안최동(땡땡아파트)',13112,'(PRD) 비회원 \"엄응진\" 특수~!@#$%^&*(),_+|\\[]{};:\'\"./<>?문자','(PRD) 비회원 \"엄응진\" 특수~!@#$%^&*(),_+|\\[]{};:\'\"./<>?문자'),
